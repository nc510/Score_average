...
# installed.
TCL_PREFIX='d:/0_TG/code2026/Score_average/Score_average/vv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/0_TG/code2026/Score_average/Score_average/vv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/0_TG/code2026/Score_average/Score_average/vv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/0_TG/code2026/Score_average/Score_average/vv\Library\include'
...
TCL_PACKAGE_PATH='d:/0_TG/code2026/Score_average/Score_average/vv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/0_TG/code2026/Score_average/Score_average/vv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/0_TG/code2026/Score_average/Score_average/vv\Library\lib\tclstub86.lib'
